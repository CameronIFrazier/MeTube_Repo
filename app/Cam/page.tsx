      ...
      <div className="w-[60%] mx-auto px-6 pt-6">
        ...
        <div className="border-b border-gray-700 mt-8">
          <div className="flex gap-8 overflow-x-auto">
            <div className="tab py-4 text-muted">About Me</div>
          </div>
        </div>
        <p className="pt-4">
          Hello, my names&apos; Cameron, and welcome to MyTube. Allow me to
          introduce myself! I&apos;m a husband, gamer, and web developer.
          I&apos;m trying to step into the industy, hence why I made this
          website.
        </p>
        <div className="border-b border-gray-700 mt-8">
          <div className="flex gap-8 overflow-x-auto">
            <div className="tab py-4 text-muted">Content</div>
          </div>
        </div>
