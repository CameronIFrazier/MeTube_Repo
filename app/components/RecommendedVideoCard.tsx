...
export default function RecommendedVideoCard({
  ...
  return (
    <div className="flex gap-3 cursor-pointer hover:bg-neutral-800/60 p-2 rounded-lg transition w-full">
      {/* Thumbnail */}
...
//IF YOU ARE LOOKING FOR THE THREE DOTS THOS ARE IN THE VIDEO PAGE .MAP FUNCTION WITH THE RECOMMENDED VIDEOS